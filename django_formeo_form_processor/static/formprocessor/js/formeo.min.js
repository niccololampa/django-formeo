                    ...
                    action: {
                        click: function (e) {
                            ...
                            if (t === 1) {
                                ...
                                $('<button id="bulk-upload" type="button" class="add-options hide">Bulk Upload Options</button>').insertAfter(edit)

                                $("#bulk-upload").click(function (event) {

                                    currentIdEdit = ($(event.target).closest('li').attr('id'))
